#!/usr/bin/env python3
"""
Azure Data Factory - Sales CSV to SQL Pipeline Implementation

Reads a single CSV file from blob storage, transforms into fact/dimension tables,
and loads into Azure SQL Database using dataflow activities.

UPDATED: Two dataflows to ensure dimensions load before fact table.
"""
...
AggregateDimTime derive(ORDERDATE = toDate(ORDERDATE, 'MM/dd/yyyy')) ~> DeriveDimTime
...
SelectFactSales derive(ORDERDATE = toDate(ORDERDATE, 'MM/dd/yyyy')) ~> DeriveFactSales
